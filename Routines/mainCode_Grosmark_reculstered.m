...
[primaryPBEs_pre, sdat_pre] = PBPeriods(MUA, fileinfo, [], time_resolution, threshZ, exclude, 0);
...
[primaryPBEs_run, sdat_run] = PBPeriods(MUA, fileinfo, [], time_resolution, 3, exclude, 0);
