...
% 
% % 
% % cnctPRE = cell2mat(eventsBinnedfiringPRE(:, 2)');
% % meanFRs_PRE = mean(cnctPRE, 2);
% % stdFRs_PRE = std(cnctPRE, [], 2);
% % 
% % for pbe = 1: size(eventsBinnedfiringPRE, 1)
% %     
% %     currPBE = eventsBinnedfiringPRE{pbe, 2};
% %     eventsBinnedfiringPRE{pbe, 2} = (currPBE - repmat(meanFRs_PRE, [1, size(currPBE, 2)]))./ repmat(stdFRs_PRE, [1, size(currPBE, 2)]);  
% %     eventsBinnedfiringPRE{pbe, 2}(isnan(eventsBinnedfiringPRE{pbe, 2})) = 0;
% % end
% 
% 
...
subplot(3,3,1)
plotPanel(RUN_PRE_PopVecSim, sortRUN_PRE, 'RUN', 'PRE', [], currTitle)

subplot(3,3,2)
plotPanel(POST_RUN_PopVecSim, sortPOST_RUN, 'POST', 'RUN', [], '')

subplot(3,3,3)
plotPanel(POST_PRE_PopVecSim, sortPOST_PRE, 'POST', 'PRE', [], '')
...
subplot(3,3,4)
plotPanel(RUN_PRE, sortRUN_PRE, 'RUN', 'PRE', [], currTitle)

subplot(3,3,5)
plotPanel(POST_RUN, sortPOST_RUN, 'POST', 'RUN', [], '')

subplot(3,3,6)
plotPanel(POST_PRE, sortPOST_PRE, 'POST', 'PRE', [], '')
...
subplot(3,3,7)
plotPanel(RUN_PRE_ts, sortRUN_PRE, 'RUN', 'PRE', [], currTitle)

subplot(3,3,8)
plotPanel(POST_RUN_ts, sortPOST_RUN, 'POST', 'RUN', [], '')

subplot(3,3,9)
plotPanel(POST_PRE_ts, sortPOST_PRE, 'POST', 'PRE', [], '')
