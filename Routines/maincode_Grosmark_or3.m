...
FileBase = fullfile(currDir, 'analysesResults', fileinfo.name);
mkdir(FileBase)
...
subfolder = fullfile(FileBase, 'PlaceFields');
mkdir(subfolder)

% 
% spatialTunings2D_L2R = spatialTuning_2D(spikeStruct, [1 2 3], fileinfo, behavior, speed, 'L2R', 2, runSpeedThresh, fileinfo.Fs, subfolder);
% spatialTunings2D_R2L = spatialTuning_2D(spikeStruct, [1 2 3], fileinfo, behavior, speed, 'R2L', 2, runSpeedThresh, fileinfo.Fs, subfolder);
...
[spatialTunings_L2R, PF_sorted_L2R, PF_peak_L2R, activeUnits_sorted_L2R, sparsity_L2R] = spatialTuning_1D(spikeStruct, [1 2 3], fileinfo, behavior, speed, 'L2R', 2, runSpeedThresh, fileinfo.Fs, subfolder);
[spatialTunings_R2L, PF_sorted_R2L, PF_peak_R2L, activeUnits_sorted_R2L, sparsity_R2L] = spatialTuning_1D(spikeStruct, [1 2 3], fileinfo, behavior, speed, 'R2L', 2, runSpeedThresh, fileinfo.Fs, subfolder);
...
subfolder = fullfile(FileBase, 'PBEs', 'PRE');
mkdir(subfolder)
...
subfolder = fullfile(FileBase, 'PBEs', 'RUN');
mkdir(subfolder)
...
subfolder = fullfile(FileBase, 'PBEs', 'POST');
mkdir(subfolder)
...
laps_L2R_idx = 1:2:length(laps);

laps_L2R_idx = find(ismember(laps(:,3), laps_L2R_idx));

laps_L2R    = laps(laps_L2R_idx, :);

individualAndPopulationSpatialInfo(spikeStruct, laps_L2R, spatialTunings_L2R, PF_peak_L2R, sparsity_L2R, behavior, speed, runSpeedThresh, posBinSize, binDur, 'L2R', fileinfo, subfolder);
...
% R2L
laps_R2L_idx = 2:2:length(laps);
% laps_R2L_idx = 1:length(laps);

laps_R2L_idx = find(ismember(laps(:,3), laps_R2L_idx));

laps_R2L    = laps(laps_R2L_idx, :);

individualAndPopulationSpatialInfo(spikeStruct, laps_R2L, spatialTunings_R2L, PF_peak_R2L, sparsity_R2L, behavior, speed, runSpeedThresh, posBinSize, binDur, 'R2L', fileinfo, subfolder);



%% Replay assessment using Bayesian decoding
...
subfolder = fullfile(FileBase, 'Bayesian', 'PRE');
mkdir(subfolder)

% BDreplayDetect_grosmark(eventsBinnedfiringPRE, spatialTunings_R2L, [], binDur, subfolder, 'data');
BDreplayDetect(eventsBinnedfiringPRE, spatialTunings_L2R, spatialTunings_R2L, [], binDur, subfolder, 'data');
...
% BDreplayDetect_grosmark(eventsBinnedfiringPRE_ts,  spatialTunings_R2L, [], binDur, subfolder, 'shuffle');
BDreplayDetect(eventsBinnedfiringPRE_ts, spatialTunings_L2R, spatialTunings_R2L, [], binDur, subfolder, 'shuffle');
...
subfolder = fullfile(FileBase, 'Bayesian', 'RUN');
mkdir(subfolder)

% BDreplayDetect_grosmark(eventsBinnedfiringRUN, spatialTunings_R2L, [], binDur, subfolder, 'data');
BDreplayDetect(eventsBinnedfiringRUN, spatialTunings_L2R, spatialTunings_R2L, [], binDur, subfolder, 'data');
...
% BDreplayDetect_grosmark(eventsBinnedfiringRUN_ts, spatialTunings_R2L, [], binDur, subfolder, 'shuffle');
BDreplayDetect(eventsBinnedfiringRUN_ts, spatialTunings_L2R, spatialTunings_R2L, [], binDur, subfolder, 'shuffle');


% POST

subfolder = fullfile(FileBase, 'Bayesian', 'POST');
mkdir(subfolder)

% BDreplayDetect_grosmark(eventsBinnedfiringPOST, spatialTunings_R2L, [], binDur, subfolder, 'data');
BDreplayDetect(eventsBinnedfiringPOST, spatialTunings_L2R, spatialTunings_R2L, [], binDur, subfolder, 'data');
...
% BDreplayDetect_grosmark(eventsBinnedfiringPOST_ts, spatialTunings_R2L, [], binDur, subfolder, 'shuffle');
BDreplayDetect(eventsBinnedfiringPOST_ts, spatialTunings_L2R, spatialTunings_R2L, [], binDur, subfolder, 'shuffle');
...
subfolder = fullfile(FileBase, 'Bayesian', 'PRE', 'data');

load(fullfile(subfolder, 'BDresults.mat'))
...
% tempPlotBD2(eventsBinnedfiringPRE, PosteriorProbMatrix, BDprctile, begPosition, endPosition, activeUnits_sorted_R2L, PBEidx2plot, binDur, subfolder)
tempPlotBD(eventsBinnedfiringPRE, PosteriorProbMatrix, BDprctile, begPosition, endPosition, activeUnits_sorted_L2R, activeUnits_sorted_R2L, PBEidx2plot, binDur, subfolder)
...
subfolder = fullfile(FileBase, 'Bayesian', 'RUN', 'data');
...
% tempPlotBD2(eventsBinnedfiringRUN, PosteriorProbMatrix, BDprctile, begPosition, endPosition, activeUnits_sorted_R2L, PBEidx2plot, binDur, subfolder)
tempPlotBD(eventsBinnedfiringRUN, PosteriorProbMatrix, BDprctile, begPosition, endPosition, activeUnits_sorted_L2R, activeUnits_sorted_R2L, PBEidx2plot, binDur, subfolder)
...
subfolder = fullfile(FileBase, 'Bayesian', 'POST', 'data');
...
% tempPlotBD2(eventsBinnedfiringPOST, PosteriorProbMatrix, BDprctile, begPosition, endPosition, activeUnits_sorted_R2L, PBEidx2plot, binDur, subfolder)
tempPlotBD(eventsBinnedfiringPOST, PosteriorProbMatrix, BDprctile, begPosition, endPosition, activeUnits_sorted_L2R, activeUnits_sorted_R2L, PBEidx2plot, binDur, subfolder)
...
% 
% 
% function [eventsBinnedfiring, secondaryPBEs, idx_acceptedEvents] = finalBinningResult(pbEvents2, spikeStruct, fileinfo)
% 
...
% 
% [eventsBinnedfiring2, noFiringUnits] = timeBinning(pbEvents2, spikeStruct, qclus, binDur, fileinfo);
% 
% 
...
% 
% 
% function [runBinnedfiring, posbinIdx, xposcenters, yposcenters] = binRunData(spikeStruct, activePeriods, behavior, binDur, posBinSize, fileinfo)
% 
% 
...
% 
% runBinnedfiring2 = timeBinning(activePeriods , spikeStruct, qclus, binDur, fileinfo); % the theta periods
% 
% 
% 
