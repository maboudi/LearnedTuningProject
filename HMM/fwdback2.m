function [alpha, beta, gamma, loglik, xi_summed, gamma2] = fwdback2(init_state_distrib, ...
   transmat, transmat_shuffle, obslik, varargin)
...
for t=2:T
 ...
 %%% the following part is added in the modified version (fwdback2)
 if ismember(t, 2:T-1) %%%%
     trans = transmat{act(t-1)};
 elseif t == T
     trans = transmat_shuffle;
 end
