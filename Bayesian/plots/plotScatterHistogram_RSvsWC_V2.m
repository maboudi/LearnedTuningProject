function plotScatterHistogram_RSvsWC_V2(BDscores, directory)
...
for jj = 1:length(shuffleMethods)
    ...
    xdata = BDscores.(period).(shuffleMethod).weightedCorr;
    ydata = BDscores.(period).(shuffleMethod).replayScore;
    ...
    dim = [0.15 0.6 0.5 .1];
    annotation('textbox',dim,'String', shuffleMethod, 'FitBoxToText','on', 'Interpreter', 'none');
