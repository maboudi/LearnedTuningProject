function tempPlotBD_1D(eventsBinnedFiring, posteriorProbMatrix, seqScore, begPosition, endPosition, template, PBEidx2plot, binDur, fileBase)
...
%        print(gcf, filename, '-dpng', '-r0')
    ...
    for i = 1:nor
        ...
        for j = 1:noc
            ...
            spikes = currEvent(template, :); %%% for raster of place cells in each direction
