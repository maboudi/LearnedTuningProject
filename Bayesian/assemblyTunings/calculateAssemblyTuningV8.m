function [assemblyTunings, px, spikeCountProbs, nCoactiveUnits_wEachUnit, nCoactiveUnits] = calculateAssemblyTuningV8(PBEInfo, spikes, selectPBEs, clusterQuality, ifshuffle)


% excluding same shank units 
...
%     otherUnits = includedUnits_otherShanks;
