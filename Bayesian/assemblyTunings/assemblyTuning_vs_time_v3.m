function assemblyTuning_vs_time_v3(sessionNumber)
...
for iepoch = 1:3
    ...
    ifshuffle = 0;
    currAssemblyTunings = calculateAssemblyTuning_vs_time_v2(PBEInfo, spikes, selectPBEs, clusterQuality, ifshuffle);
