function [assemblyTunings, px, spikeCountProbs, nCoactiveUnits_wEachUnit, nCoactiveUnits] = calculateAssemblyTuningV6(PBEInfo, spikes, selectPBEs, clusterQuality, ifshuffle)
