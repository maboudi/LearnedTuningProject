function assemblyTuning_selectedPeriods_moreShuffles_NREM(sessionNumber)
...
%                 concatBoutIDs.(currEpoch), boutFirings_unit.(currEpoch).data] = calculateAssemblyTuning_selectedPeriods(currBouts, spikes, binDur, clusterQuality, ifShuffle);
    ...
    fileName = sprintf('%s.assemblyTunings_NREM_nonPBE_moreShuffles_%.3f.mat', sessionName, binDur);
