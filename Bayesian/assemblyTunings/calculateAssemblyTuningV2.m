function [assemblyTunings, px, spikeCountProbs, nCoactiveUnits_wEachUnit, nCoactiveUnits] = calculateAssemblyTuningV2(PBEbinnedFirings, placeFieldsRL, placeFieldsLR, selectPBEs, ifshuffle)
...
for iUnit = 1:nActiveUnits
    ...
    nCoactiveUnits_wEachUnit{currUnit} = nan(nTimeBins, 1); 
    nCoactiveUnits_wEachUnit{currUnit}(concatPBEfirings_unit > 0) = nFiringUnitEachBin(concatPBEfirings_unit > 0);
