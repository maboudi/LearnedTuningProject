function assemblyTunings = calculateAssemblyTuning_vs_time(PBEInfo, spikes, selectPBEs, clusterQuality, ifshuffle)
...
assemblyTunings = zeros(nUnits, nPosBins, nPBE_subsets);
...
for iUnit = 1:nActiveUnits
    ...
    PBEfirings_unit       = cell(TN_PBEs, 1);
    PBEfirings_otherUnits = cell(TN_PBEs, 1);
